...
//		setScreenUpdateMode(-1, mReaderView);
	...
	private InterfaceTheme currentTheme = InterfaceTheme.WHITE;
	public InterfaceTheme getCurrentTheme() {
		return currentTheme;
	}

	public void setCurrentTheme(String themeCode) {
		themeCode = "WHITE";// thiensuhack
...
//		    public static final int KEYCODE_PAGE_TOPRIGHT = 0x5e; // back
		...
		public Properties loadSettings(BaseActivity activity, File file) {
          ...
          // default tap zone actions
	        ...
	        //props.applyDefault(ReaderView.PROP_FONT_COLOR_NIGHT, "#808080"); //thiensuhack
	        props.applyDefault(Settings.PROP_FONT_COLOR_NIGHT, "#FFFFFF");
	        
	        //props.applyDefault(ReaderView.PROP_BACKGROUND_COLOR, "#FFFFFF"); //thiensuhack
	        props.applyDefault(Settings.PROP_BACKGROUND_COLOR, "#000000");
...
//	        props.applyDefault(ReaderView.PROP_APP_FULLSCREEN, "0");//thiensuhack
			...
			//thiensuhack orientation
//			/props.applyDefault(ReaderView.PROP_APP_SCREEN_ORIENTATION, DeviceInfo.EINK_SCREEN ? "0" : "4"); // "0"
			props.applyDefault(Settings.PROP_APP_SCREEN_ORIENTATION, "0"); // "0"//thiensuhack
			// defaul
			// Portrait
			...
			props.applyDefault(Settings.PROP_TOOLBAR_HIDE_IN_FULLSCREEN, "1");
