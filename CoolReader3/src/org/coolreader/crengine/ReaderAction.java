...
//thiensuhack
	...
	public final static ReaderAction GO_BACK = new ReaderAction("GO_BACK",
			R.string.action_go_back, ReaderCommand.DCMD_EXIT, 0,
			R.id.cr3_go_back).setIconId(R.drawable.cr3_button_prev);
